                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="reason" id="select" class="form-control" value="{{ old('reason') }}" >
                                        ...
                                        @foreach($reasons as $reasonResult)
                                            <option value="{{ $reasonResult->reason_id }}">{{ ucfirst(str_replace('-', ' ', $reasonResult->reason_id)) }}</option>
                                        @endforeach
                                    </select>
                                    @error('reason')
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="subject" name="subject" placeholder="Subject" value="{{ old('subject') }}" class="form-control">
                                    @error('subject')
                                    <span class="help-block text-danger">{{ $subject }}</span>
                                    @enderror
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="message" id="textarea-input" rows="9" placeholder="Message" class="form-control">{{ old('message') }}</textarea>
                                    @error('message')
                                    <span class="help-block text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                    ...
                                    <div class="form-check">
                                        <div class="checkbox">
                                            <label for="checkbox1" class="form-check-label ">
                                                ...
                                                <input type="checkbox" id="status" name="status" value="1" class="form-check-input">Enable
                                            </label>
                                        </div>
                                    </div>
                                    @error('status')
