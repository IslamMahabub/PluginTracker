            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="overview-wrap">
                        <h2 class="title-1">Auto Settings Message</h2>
                        <h2 class="title-1">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="plugins" id="select" class="form-control" value="{{ old('plugins') }}" >
                                        ...
                                        @foreach($plugins as $pluginsResult)
                                            <option value="{{ $pluginsResult->plugin }}">{{ $pluginsResult->plugin }}</option>
                                        @endforeach
                                    </select>
                                    @error('plugins')
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="slag" name="slag" placeholder="Slug" value="{{ old('slag') }}" class="form-control" autocomplete="off">
                                    @error('slag')
                                    <span class="help-block text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
